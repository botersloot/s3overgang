...
class Fourth(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        self.lbl8b = QtGui.QLabel('Latijn', self)
        self.lbl8b.resize(self.lbl8b.sizeHint())
        self.lbl8b.move(50, 260)
        ...
        self.lbl16b = QtGui.QLabel('Grieks', self)
        self.lbl16b.resize(self.lbl16b.sizeHint())
        self.lbl16b.move(350, 260)
        ...
        self.qle8b = QtGui.QLineEdit(self)
        self.qle8b.resize(self.qle8b.sizeHint())
        self.qle8b.move(170, 260)
        ...
        self.qle16b = QtGui.QLineEdit(self)
        self.qle16b.resize(self.qle16b.sizeHint())
        self.qle16b.move(430, 260)
